<x-guest-layout>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="mt-4" x-data="{ show: false }">
            ...
            <div class="relative">
                {{-- FINAL FIX: Replaced @type logic with input tag to allow Alpine binding --}}
                <input id="password" class="block mt-1 w-full border-gray-300 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm"
                ...
                <div class="absolute inset-y-0 right-0 pr-3 flex items-center text-gray-400">
                    <button type="button" x-on:click="show = !show" class="focus:outline-none">
                        {{-- Show "Eye Slash" icon when password is not visible --}}
